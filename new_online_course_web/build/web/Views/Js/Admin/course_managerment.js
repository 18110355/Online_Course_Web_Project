...
{
    window.location = url + "/course-managerment?courseId=" + courseId + "&stateApproved=approved";
}
...
{
    window.location = url + "/course-managerment?isShowEmail=false";
}

function ShowFrontDivSendEmail(courseId, state)
{
    window.location = url + "/course-managerment?isShowEmail=true&courseId=" + courseId + "&stateApproved=" + state;
}

function goCourse(courseId)
{
     window.location = url + "/Display_Course_Introduction_Student?courseid=" + courseId;
}