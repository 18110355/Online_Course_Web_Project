...
{
    status = !status;
    window.location = url + "/account-managerment?status=" + status + "&userId=" + userId;
}
...
{
    window.location = "/account-managerment?isShowReport=false";
}

function ShowFrontDivReport()
{
    window.location = url + "/account-managerment?isShowReport=true";
}

function CloseFrontDivAddAdmin()
{
    window.location = url + "/account-managerment?isShowAddAdmin=false";
}

function ShowFrontDivAddAdmin()
{
    window.location = url + "/account-managerment?isShowAddAdmin=true";
}
